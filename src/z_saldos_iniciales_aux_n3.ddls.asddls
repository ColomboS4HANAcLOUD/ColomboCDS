...
@EndUserText.label: 'Saldos Iniciales Cta Nivel 3'
define view entity Z_SALDOS_INICIALES_AUX_N3 with parameters FechaInicial : datum
 as select from Z_SALDOS_INICIALES (FechaInicial : $parameters.FechaInicial ) as Saldos
{
  
  key left(Saldos.GLAccount,5) as GLAccount,
