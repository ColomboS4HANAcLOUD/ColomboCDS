...
@EndUserText.label: 'Debitos y Creditos por Cta Nivel 4'
define view entity Z_DEBITOS_CREDITOS_AUX_N4 with parameters  
 FechaInicial : datum,
 FechaFinal : datum
 as select from Z_DEBITOS_CREDITOS (FechaInicial : $parameters.FechaInicial , FechaFinal : $parameters.FechaFinal) as Sumatoria
{
  key left(Sumatoria.GLAccount,6) as GLAccount,
