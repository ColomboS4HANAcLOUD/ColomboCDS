...
@EndUserText.label: 'Debitos y Creditos por Cta Nivel 5'
define view entity Z_DEBITOS_CREDITOS_AUX_N5 with parameters  
 FechaInicial : datum,
 FechaFinal : datum
 as select from Z_DEBITOS_CREDITOS (FechaInicial : $parameters.FechaInicial , FechaFinal : $parameters.FechaFinal) as Sumatoria
{
  key left(Sumatoria.GLAccount,7) as GLAccount,
