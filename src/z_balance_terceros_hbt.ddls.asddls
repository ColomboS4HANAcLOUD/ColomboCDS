...
define view entity Z_BALANCE_TERCEROS_HBT
  ...
  as select distinct from Z_DIARIO_NIVEL_6          as Balance
    ...
    left outer join       Z_SOCIOS_BALANCE          as Socios      on Socios.Socio   = Referencias.Reference1IDByBusinessPartner
                                                                   or Socios.SocioBP = Balance.YY1_HBT_Tercero_S4_COB
...

{
  ...
  key  Balance.FiscalYear,
       ...
       then Referencias.Reference1IDByBusinessPartner
         ...
         case when Balance.YY1_HBT_Tercero_S4_COB is initial
       then Socios.NitSN --Referencias.Reference2IDByBusinessPartner
       else Socios.NitSN
       end as Ref2,
       ...
       */
       ...
       ---Balance.YY1_HBTTercero_COB,
       ---Balance.YY1_HBT_Tercero_S4_COB,
       --- Balance.YY1_HBT_Tercero_JEI,
